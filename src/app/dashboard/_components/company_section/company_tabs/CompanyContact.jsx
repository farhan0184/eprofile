...
export default function CompanyContact({ setValue, company, setCompany, setSingleCompany, isEdit, companyId, updateSingleCompany }) {
    ...
    const handleNext = async () => {
        if (!isEdit) {
            ...
            const res = await setSingleCompany(formData)
            console.log(res);
            ...
            const res = await updateSingleCompany({ contact: data }, companyId)
