...
import softronixs from "@/assets/images/company1.jpeg";
...
import vk from "../../assets/images/VK Logomark.png";
import github from "../../assets/images/GitHub Logotype.png";
      ...
      <div>
        <div className="px-6 border-b-2 relative md:px-14 lg:px-20 py-4 md:py-5 lg:py-7">
          <div
            ...
            style={{
              backgroundImage: `url('https://i.ibb.co/FHKDwGM/service.jpg')`,
